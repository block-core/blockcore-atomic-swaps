...
namespace Blockcore.AtomicSwaps.TradingView
{

    public class ChartHelper : IAsyncDisposable
    {
        private readonly Lazy<Task<IJSObjectReference>> moduleTask;
        public ChartHelper(IJSRuntime jsRuntime)
        {
            moduleTask = new(() => jsRuntime.InvokeAsync<IJSObjectReference>(
               "import", "./_content/Blockcore.AtomicSwaps.TradingView/chartHelper.js").AsTask());
        }
