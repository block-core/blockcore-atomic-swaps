...
// Class definition
var DEXCreateCampaign = function () {
	// Elements
	var modal;
	var modalEl;
	...
	var initStepper = function () {
		...
		formSubmitButton.addEventListener('click', function (e) {
			...
			formSubmitButton.setAttribute('data-dex-indicator', 'on');

			// Simulate form submission
			setTimeout(function () {
				// Hide loading indication
				formSubmitButton.removeAttribute('data-dex-indicator');
	...
	var initForm = function () {
		// Init age slider
		var slider = document.querySelector("#dex_modal_create_campaign_age_slider");
		var valueMin = document.querySelector("#dex_modal_create_campaign_age_min");
		var valueMax = document.querySelector("#dex_modal_create_campaign_age_max");
		...
		// Init tagify
		var tagify = new Tagify(document.querySelector('#dex_modal_create_campaign_location'), {
			delimiters: null,
			templates: {
		...
		// Init flatpickr
		$("#dex_modal_create_campaign_datepicker").flatpickr({
			altInput: true,
			enableTime: true,
			altFormat: "F j, Y H:i",
		...
		// Init dropzone
		var myDropzone = new Dropzone("#dex_modal_create_campaign_files_upload", {
		...
		const allDuration = document.querySelector('#dex_modal_create_campaign_duration_all');
		const fixedDuration = document.querySelector('#dex_modal_create_campaign_duration_fixed');
		const datepicker = document.querySelector('#dex_modal_create_campaign_datepicker');
		...
		// Init budget slider
		var budgetSlider = document.querySelector("#dex_modal_create_campaign_budget_slider");
		var budgetValue = document.querySelector("#dex_modal_create_campaign_budget_label");
		...
		const restartButton = document.querySelector('#dex_modal_create_campaign_create_new');
	...
	return {
		...
		init: function () {
			// Elements
			modalEl = document.querySelector('#dex_modal_create_campaign');
			...
			stepper = document.querySelector('#dex_modal_create_campaign_stepper');
			form = document.querySelector('#dex_modal_create_campaign_stepper_form');
			formSubmitButton = stepper.querySelector('[data-dex-stepper-action="submit"]');
			formContinueButton = stepper.querySelector('[data-dex-stepper-action="next"]');
