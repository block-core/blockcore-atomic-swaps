...
// Class definition
var DEXUsersPermissionsList = function () {
    // Shared variables
    var datatable;
    var table;
    ...
    var handleSearchDatatable = () => {
        const filterSearch = document.querySelector('[data-dex-permissions-table-filter="search"]');
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = table.querySelectorAll('[data-dex-permissions-table-filter="delete_row"]');
    ...
    return {
        // Public functions
        init: function () {
            table = document.querySelector('#dex_permissions_table');
