...
// Class definition
var DEXUsersViewMain = function () {

    // Init login session button
    var initLoginSession = () => {
        const button = document.getElementById('dex_modal_sign_out_sesions');
    ...
    var initSignOutUser = () => {
        const signOutButtons = document.querySelectorAll('[data-dex-users-sign-out="single_user"]');
    ...
    const initDeleteTwoStep = () => {
        const deleteButton = document.getElementById('dex_users_delete_two_step');
    ...
    const initEmailPreferenceForm = () => {
        // Define variables
        const form = document.getElementById('dex_users_email_notification_form');
        const submitButton = form.querySelector('#dex_users_email_notification_submit');
        const cancelButton = form.querySelector('#dex_users_email_notification_cancel');
