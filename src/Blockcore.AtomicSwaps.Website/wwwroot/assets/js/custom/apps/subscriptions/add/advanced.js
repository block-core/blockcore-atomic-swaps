...
var DEXSubscriptionsAdvanced = function () {
    // Shared variables
    var table;
    var datatable;
    ...
    var initCustomFieldsDatatable = function () {
        // Define variables
        const addButton = document.getElementById('dex_create_new_custom_fields_add');
    ...
    var deleteCustomField = function() {
        DEXUtil.on(table, '[data-dex-action="field_remove"]', 'click', function(e) {
            e.preventDefault();
    ...
    return {
        init: function () {
            table = document.getElementById('dex_create_new_custom_fields');
