...
// Class definition
var DEXFileManagerList = function () {
    ...
    // Private functions
    const initTemplates = () => {
        uploadTemplate = document.querySelector('[data-dex-filemanager-template="upload"]');
        renameTemplate = document.querySelector('[data-dex-filemanager-template="rename"]');
        actionTemplate = document.querySelector('[data-dex-filemanager-template="action"]');
        checkboxTemplate = document.querySelector('[data-dex-filemanager-template="checkbox"]');
    }
    ...
    const initDatatable = () => {
        ...
        var loadOptions;
        if (table.getAttribute('data-dex-filemanager-table') === 'folders') {
    ...
    const handleSearchDatatable = () => {
        const filterSearch = document.querySelector('[data-dex-filemanager-table-filter="search"]');
    ...
    const handleDeleteRows = () => {
        ...
        const deleteButtons = table.querySelectorAll('[data-dex-filemanager-table-filter="delete_row"]');
    ...
    const initToggleToolbar = () => {
        ...
        if (table.getAttribute('data-dex-filemanager-table') === 'folders') {
            checkboxes = document.querySelectorAll('#dex_file_manager_list_wrapper [type="checkbox"]');
        }

        // Select elements
        const deleteSelected = document.querySelector('[data-dex-filemanager-table-select="delete_selected"]');
    ...
    const toggleToolbars = () => {
        // Define variables
        const toolbarBase = document.querySelector('[data-dex-filemanager-table-toolbar="base"]');
        const toolbarSelected = document.querySelector('[data-dex-filemanager-table-toolbar="selected"]');
        const selectedCount = document.querySelector('[data-dex-filemanager-table-select="selected_count"]');
    ...
    const handleNewFolder = () => {
        // Select button
        const newFolder = document.getElementById('dex_file_manager_new_folder');
        ...
        newFolder.addEventListener('click', e => {
            ...
            if (table.querySelector('#dex_file_manager_new_folder_row')) {
                return;
            }
            ...
            const rowForm = rowElement.querySelector('#dex_file_manager_add_folder_form');
            const rowButton = rowElement.querySelector('#dex_file_manager_add_folder');
            const cancelButton = rowElement.querySelector('#dex_file_manager_cancel_folder');
            ...
            rowButton.addEventListener('click', e => {
                ...
                // Activate indicator
                rowButton.setAttribute("data-dex-indicator", "on");
                    ...
                    validator.validate().then(function (status) {
                        ...
                        if (status == 'Valid') {
                            ...
                            setTimeout(function () {
                                ...
                                $(newRow).find('td').eq(4).attr('data-dex-filemanager-table', 'action_dropdown');
                                ...
                                // Disable indicator
                                rowButton.removeAttribute("data-dex-indicator");
            ...
            cancelButton.addEventListener('click', e => {
                ...
                // Activate indicator
                cancelButton.setAttribute("data-dex-indicator", "on");

                setTimeout(function () {
                    // Disable indicator
                    cancelButton.removeAttribute("data-dex-indicator");
    ...
    const resetNewFolder = () => {
        const newFolderRow = table.querySelector('#dex_file_manager_new_folder_row');
    ...
    const handleRename = () => {
        const renameButton = table.querySelectorAll('[data-dex-filemanager-table="rename"]');     
    ...
    const renameCallback = (e) => {
        ...
        if (table.querySelectorAll('#dex_file_manager_rename_input').length > 0) {
            Swal.fire({
        ...
        renameInput.querySelector('#dex_file_manager_rename_folder_icon').innerHTML = colIcon.outerHTML;
        ...
        parent.querySelector('#dex_file_manager_rename_input').value = nameValue;
        ...
        const renameInputButton = document.querySelector('#dex_file_manager_rename_folder');
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                Swal.fire({
                                    ...
                                    const newValue = document.querySelector('#dex_file_manager_rename_input').value;
        ...
        // Cancel rename input
        const cancelInputButton = document.querySelector('#dex_file_manager_rename_folder_cancel');
        cancelInputButton.addEventListener('click', e => {
            e.preventDefault();

            // Simulate process for demo only
            cancelInputButton.setAttribute("data-dex-indicator", "on");
            ...
            setTimeout(function () {
                ...
                // Remove spinner
                cancelInputButton.removeAttribute("data-dex-indicator");
    ...
    const initDropzone = () => {
        ...
        const id = "#dex_modal_upload_dropzone";
    ...
    const initCopyLink = () => {
        ...
        const elements = table.querySelectorAll('[data-dex-filemanger-table="copy_link"]');

        elements.forEach(el => {
            // Define elements
            const button = el.querySelector('button');
            const generator = el.querySelector('[data-dex-filemanger-table="copy_link_generator"]');
            const result = el.querySelector('[data-dex-filemanger-table="copy_link_result"]');
    ...
    const handleMoveToFolder = () => {
        const element = document.querySelector('#dex_modal_move_to_folder');
        const form = element.querySelector('#dex_modal_move_to_folder_form');
        const saveButton = form.querySelector('#dex_modal_move_to_folder_submit');
    ...
    const countTotalItems = () => {
        const counter = document.getElementById('dex_file_manager_items_counter');
    ...
    return {
        init: function () {
            table = document.querySelector('#dex_file_manager_list');
