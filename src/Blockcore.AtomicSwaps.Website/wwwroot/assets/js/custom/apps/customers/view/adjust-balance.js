...
// Class definition
var DEXModalAdjustBalance = function () {
    var element;
    var submitButton;
    var cancelButton;
    var closeButton;
    ...
    var initForm = function () {
        ...
        Inputmask("US$ 9,999,999.99", {
            "numericInput": true
        }).mask("#dex_modal_inputmask");
    }

    var handleBalanceCalculator = function () {
        // Select elements
        const currentBalance = element.querySelector('[dex-modal-adjust-balance="current_balance"]');
        newBalance = element.querySelector('[dex-modal-adjust-balance="new_balance"]');
        maskInput = document.getElementById('dex_modal_inputmask');
    ...
    return {
        ...
        init: function () {
            // Elements
            element = document.querySelector('#dex_modal_adjust_balance');
            modal = new bootstrap.Modal(element);

            form = element.querySelector('#dex_modal_adjust_balance_form');
            submitButton = form.querySelector('#dex_modal_adjust_balance_submit');
            cancelButton = form.querySelector('#dex_modal_adjust_balance_cancel');
            closeButton = element.querySelector('#dex_modal_adjust_balance_close');
