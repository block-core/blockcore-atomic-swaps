...
// Class definition
var DEXAccountSettingsProfileDetails = function () {
    // Private variables
    var form;
    var submitButton;
    var validation;
    ...
    return {
        init: function () {
            form = document.getElementById('dex_account_profile_details_form');
            
            if (!form) {
                return;
            }

            submitButton = form.querySelector('#dex_account_profile_details_submit');
