...
namespace Blockcore.Networks.Implx
{
    public class ImpleumMain : Network
    {
        public ImpleumMain()
        {
            this.Name = "ImpleumMain";
            ...
            this.Base58Prefixes[(int)Base58Type.PUBKEY_ADDRESS] = new byte[] { 76 }; // X
            this.Base58Prefixes[(int)Base58Type.SCRIPT_ADDRESS] = new byte[] { 141 }; // y
            this.Base58Prefixes[(int)Base58Type.SECRET_KEY] = new byte[] { (76 + 141) };
    ...
    public class ImplxTransaction : Transaction
    {
        public ImplxTransaction() : base()
        {
        }

        public ImplxTransaction(string hex, ConsensusFactory consensusFactory) : this()
        {
            this.FromBytes(Encoders.Hex.DecodeData(hex), consensusFactory);
        }

        public ImplxTransaction(byte[] bytes) : this()
        {
    ...
    public class ImplxPosBlockHeader : PosBlockHeader
    {
    ...
    public class ImplxConsensusFactory : PosConsensusFactory
    {
        /// <inheritdoc />
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        {
            return new ImplxPosBlockHeader();
        }

        /// <inheritdoc />
        public override Transaction CreateTransaction()
        {
            return new ImplxTransaction();
        }

        /// <inheritdoc />
        public override Transaction CreateTransaction(string hex)
        {
            return new ImplxTransaction(hex, this);
        }

        /// <inheritdoc />
        public override Transaction CreateTransaction(byte[] bytes)
        {
            return new ImplxTransaction(bytes);
        }
    }
