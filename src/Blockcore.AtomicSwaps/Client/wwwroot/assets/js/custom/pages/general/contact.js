...
var DEXContactApply = function () {
	...
	return {
		...
		init: function () {
			// Elements
			form = document.querySelector('#dex_contact_form');
			submitButton = document.getElementById('dex_contact_submit_button');

			initForm();
			handleForm();
			initMap('dex_contact_map');
		}
	};
}();
