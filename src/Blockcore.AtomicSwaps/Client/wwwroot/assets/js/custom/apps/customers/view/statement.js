...
var DEXCustomerViewStatements = function () {
    ...
    var initStatementYear2020 = function () {
        // Define table element
        const id = '#dex_customer_view_statement_table_2';
        var table = document.querySelector(id);
    ...
    var initStatementYear2019 = function () {
        // Define table element
        const id = '#dex_customer_view_statement_table_3';
        var table = document.querySelector(id);
    ...
    var initStatementYear2018 = function () {
        // Define table element
        const id = '#dex_customer_view_statement_table_4';
        var table = document.querySelector(id);
