...
// Class definition
var DEXProjectOverview = function () {
    // Colors
    var primary = DEXUtil.getCssVariableValue('--dex-primary');
    var lightPrimary = DEXUtil.getCssVariableValue('--dex-primary-light');
    var success = DEXUtil.getCssVariableValue('--dex-success');
    var lightSuccess = DEXUtil.getCssVariableValue('--dex-success-light');
    var gray200 = DEXUtil.getCssVariableValue('--dex-gray-200');
    var gray500 = DEXUtil.getCssVariableValue('--dex-gray-500');
    ...
    var initGraph = function () {
        var element = document.getElementById("dex_project_overview_graph");
    ...
    var initTable = function () {
        var table = document.querySelector('#dex_profile_overview_table');
        ...
        const filterOrders = document.getElementById('dex_filter_orders');
        const filterYear = document.getElementById('dex_filter_year');
        ...
        var filterSearch = document.getElementById('dex_filter_search');
