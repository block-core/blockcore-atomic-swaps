...
// Class definition
var DEXModalNewTicket = function () {
	var submitButton;
	var cancelButton;
	var validator;
	var form;
	...
	var initForm = function() {
		...
		var myDropzone = new Dropzone("#dex_modal_create_ticket_attachments", { 
	...
	return {
		...
		init: function () {
			// Elements
			modalEl = document.querySelector('#dex_modal_new_ticket');
			...
			form = document.querySelector('#dex_modal_new_ticket_form');
			submitButton = document.getElementById('dex_modal_new_ticket_submit');
			cancelButton = document.getElementById('dex_modal_new_ticket_cancel');
