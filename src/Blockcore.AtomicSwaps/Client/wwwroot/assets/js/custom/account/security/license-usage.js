...
// Class definition
var DEXAccountSecurityLicenseUsage = function () {
    // Private functions
    var initLicenceCopy = function() {
        DEXUtil.each(document.querySelectorAll('#dex_security_license_usage_table [data-action="copy"]'), function(button) {
            var tr = button.closest('tr');
            var license = DEXUtil.find(tr, '[data-bs-target="license"]');
