...
// Class definition
var DEXModalSelectLocation = function () {
    // Private variables
    ...
    var initMap = function() {
        ...
        // Define Map Location
        var leaflet = L.map('dex_modal_select_location_map', {
    ...
    return {
        init: function () {
            // Elements
			modal = document.querySelector('#dex_modal_select_location');

			if (!modal) {
				return;
			}
            
            locationSelectTarget = document.querySelector('#dex_modal_select_location_target');
            locationSelectButton = document.querySelector('#dex_modal_select_location_button');
