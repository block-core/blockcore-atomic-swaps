...
// Class definition
var DEXModalCreateProjectSettings = function () {
	// Variables
	var nextButton;
	var previousButton;
	var validator;
	...
	var initForm = function() {
		...
		var myDropzone = new Dropzone("#dex_modal_create_project_settings_logo", { 
	...
	return {
		...
		init: function () {
			...
			nextButton = DEXModalCreateProject.getStepper().querySelector('[data-dex-element="settings-next"]');
			previousButton = DEXModalCreateProject.getStepper().querySelector('[data-dex-element="settings-previous"]');
...
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
	window.DEXModalCreateProjectSettings = module.exports = DEXModalCreateProjectSettings;
}
