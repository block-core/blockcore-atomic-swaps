...
// Class definition
var DEXModalCreateProjectTargets = function () {
	// Variables
	var nextButton;
	var previousButton;
	var validator;
	...
	return {
		...
		init: function () {
			...
			nextButton = DEXModalCreateProject.getStepper().querySelector('[data-dex-element="targets-next"]');
			previousButton = DEXModalCreateProject.getStepper().querySelector('[data-dex-element="targets-previous"]');
...
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
	window.DEXModalCreateProjectTargets = module.exports = DEXModalCreateProjectTargets;
}