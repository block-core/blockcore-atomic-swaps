...
var DEXModalBidding = function () {
    ...
    const initForm = () => {
        ...
        const submitButton = form.querySelector('[data-dex-modal-action-type="submit"]');
    ...
    const initSelect2Templates = () => {
        const elements = form.querySelectorAll('[data-dex-modal-bidding-type] select');
        ...
        const format = (item) => {
            ...
            var url = 'assets/media/' + item.element.getAttribute('data-dex-bidding-modal-option-icon');
            var img = $("<img>", {
    ...
    const handleBidOptions = () => {
        const options = form.querySelectorAll('[data-dex-modal-bidding="option"]');
    ...
    const handleCurrencySelector = () => {
        ...
        const swapCurrency = (target) => {
            console.log(target);
            const currencies = form.querySelectorAll('[data-dex-modal-bidding-type]');
            currencies.forEach(currency => {
                currency.classList.add('d-none');

                if (currency.getAttribute('data-dex-modal-bidding-type') === target.id) {
    ...
    const handleCancelAction = () => {
        const cancelButton = element.querySelector('[data-dex-modal-action-type="cancel"]');
        const closeButton = element.querySelector('[data-dex-modal-action-type="close"]');
    ...
    return {
        init: function () {
            // Elements
            element = document.querySelector('#dex_modal_bidding');
            form = document.getElementById('dex_modal_bidding_form');
