...
// Class definition
var DEXModalOfferADealType = function () {
	// Variables
	var nextButton;
	var validator;
	var form;
	...
	return {
		...
		init: function () {
			...
			nextButton = DEXModalOfferADeal.getStepper().querySelector('[data-dex-element="type-next"]');
...
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
	window.DEXModalOfferADealType = module.exports = DEXModalOfferADealType;
}