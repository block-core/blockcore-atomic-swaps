...
// Class definition
var DEXModalOfferADealDetails = function () {
	// Variables
	var nextButton;
	var previousButton;
	var validator;
	...
	return {
		...
		init: function () {
			...
			nextButton = DEXModalOfferADeal.getStepper().querySelector('[data-dex-element="details-next"]');
			previousButton = DEXModalOfferADeal.getStepper().querySelector('[data-dex-element="details-previous"]');
...
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
	window.DEXModalOfferADealDetails = module.exports = DEXModalOfferADealDetails;
}