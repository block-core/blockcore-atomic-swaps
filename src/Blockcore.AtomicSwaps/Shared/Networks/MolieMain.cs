...
namespace Blockcore.Networks.Mol
{
    public class MolieMain : Network
    {
        public MolieMain()
        {
            ...
            this.Magic = BitConverter.ToUInt32(Encoding.ASCII.GetBytes("Molie"));
            this.MinTxFee = 10000;
            ...
            this.Consensus = new Consensus.Consensus(
                ...
                coinType: 772, // https://github.com/satoshilabs/slips/blob/master/slip-0044.md
                ...
                maxMoney: 10500000000,
                coinbaseMaturity: 50,
                premineHeight: 2,
                premineReward: Money.Coins(1049966250),
            ...
            this.Base58Prefixes[(int)Base58Type.PUBKEY_ADDRESS] = new byte[] { 51 }; // X
            this.Base58Prefixes[(int)Base58Type.SCRIPT_ADDRESS] = new byte[] { 141 }; // y
            this.Base58Prefixes[(int)Base58Type.SECRET_KEY] = new byte[] { (51 + 141) };
            ...
            var encoder = new Bech32Encoder("mol");
            this.Bech32Encoders[(int)Bech32Type.WITNESS_PUBKEY_ADDRESS] = encoder;
            this.Bech32Encoders[(int)Bech32Type.WITNESS_SCRIPT_ADDRESS] = encoder;

            this.StandardScriptsRegistry = new MolStandardScriptsRegistry();
        }
    }

    public class MolTransaction : Transaction
    {
        public MolTransaction() : base()
        {
        }

        public MolTransaction(string hex, ConsensusFactory consensusFactory) : this()
        {
            this.FromBytes(Encoders.Hex.DecodeData(hex), consensusFactory);
        }

        public MolTransaction(byte[] bytes) : this()
        {
    ...
    public class MolPosBlockHeader : PosBlockHeader
    {
    ...
    public class MolConsensusFactory : PosConsensusFactory
    {
        /// <inheritdoc />
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        {
            return new MolPosBlockHeader();
        }

        /// <inheritdoc />
        public override Transaction CreateTransaction()
        {
            return new MolTransaction();
        }

        /// <inheritdoc />
        public override Transaction CreateTransaction(string hex)
        {
            return new MolTransaction(hex, this);
        }

        /// <inheritdoc />
        public override Transaction CreateTransaction(byte[] bytes)
        {
            return new MolTransaction(bytes);
        }
    }

    public class MolStandardScriptsRegistry : StandardScriptsRegistry
    {
